...
func TestMigrateAdminGroupSearchSettingsToDB33(t *testing.T) {
...
func TestMigrateStackEntryPoint(t *testing.T) {
	dbConn, err := bolt.Open(path.Join(t.TempDir(), "portainer-ee-mig-32.db"), 0600, &bolt.Options{Timeout: 1 * time.Second})
