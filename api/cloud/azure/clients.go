...
func (cc *CloudConnection) getContainerServiceBaseClient() *cs.BaseClient {
	if cc.cache.containerServiceBaseClient == nil {
		cc.cache.containerServiceBaseClient = &cs.BaseClient{
			Client:         cc.client,
			BaseURI:        cc.env.ResourceManagerEndpoint,
			SubscriptionID: cc.creds.SubscriptionID,
		}
...
// getManagedClusterBaseClient returns a BaseClient instance of the containerservice package
func (cc *CloudConnection) getManagedClusterBaseClient() *containerservice.BaseClient {
	if cc.cache.containerServiceBaseClient == nil {
		cc.cache.managedClusterBaseClient = &containerservice.BaseClient{
			Client:         cc.client,
			BaseURI:        cc.env.ResourceManagerEndpoint,
			SubscriptionID: cc.creds.SubscriptionID,
		}
	}
	return cc.cache.managedClusterBaseClient
}
...
func (cc *CloudConnection) getAPIManagementBaseClient() *apimanagement.BaseClient {
	if cc.cache.apiManagementBaseClient == nil {
		cc.cache.apiManagementBaseClient = &apimanagement.BaseClient{
			Client:         cc.client,
			BaseURI:        cc.env.ResourceManagerEndpoint,
			SubscriptionID: cc.creds.SubscriptionID,
		}
	}
	return cc.cache.apiManagementBaseClient
}
...
// GetContainerServicesClient returns a ContainerServicesClient instance
func (cc *CloudConnection) GetManagedClusterClient() *ManagedClustersClient {
	return &ManagedClustersClient{
		containerservice.ManagedClustersClient{
			BaseClient: *cc.getManagedClusterBaseClient(),
		},
	}
}
...
// RegionClient extends network.VirtualNetworksClient
type RegionClient struct {
	apimanagement.RegionClient
}

// GetRegionClient returns a RegionClient instance
func (cc *CloudConnection) GetRegionClient() *RegionClient {
	return &RegionClient{
		apimanagement.RegionClient{
			BaseClient: *cc.getAPIManagementBaseClient(),
		},
	}
}

// ResourceSkusClient extends compute.ResourceSkusClient
type ResourceSkusClient struct {
	compute.ResourceSkusClient
}

// GetRegionClient returns a RegionClient instance
func (cc *CloudConnection) GetResourceSkusClient() *ResourceSkusClient {
