...
func (service *CloudClusterInfoService) GKEGetInfo(credential *models.CloudCredential) (interface{}, error) {
	...
	// For example, if they added a new network to their GKE account, and
