...
type Service struct {
	dataservices.BaseDataService[portaineree.CustomTemplate, portainer.CustomTemplateID]
}
...
func NewService(connection portainer.Connection) (*Service, error) {
	...
	return &Service{
		BaseDataService: dataservices.BaseDataService[portaineree.CustomTemplate, portainer.CustomTemplateID]{
			Bucket:     BucketName,
