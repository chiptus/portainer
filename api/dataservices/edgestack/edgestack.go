...
func (service *Service) EdgeStack(ID portainer.EdgeStackID) (*portaineree.EdgeStack, error) {
...
func (service *Service) Create(id portainer.EdgeStackID, edgeStack *portaineree.EdgeStack) error {
	edgeStack.ID = id
...
func (service *Service) UpdateEdgeStack(ID portainer.EdgeStackID, edgeStack *portaineree.EdgeStack, cleanupCache bool) error {
	service.mu.Lock()
...
func (service *Service) UpdateEdgeStackFunc(ID portainer.EdgeStackID, updateFunc func(edgeStack *portaineree.EdgeStack)) error {
...
func (service *Service) UpdateEdgeStackFuncTx(tx portainer.Transaction, ID portainer.EdgeStackID, updateFunc func(edgeStack *portaineree.EdgeStack)) error {
