...
func UpdateGitObject(gitService portaineree.GitService, dataStore dataservices.DataStore, objId string, gitConfig *gittypes.RepoConfig, autoUpdateConfig *portaineree.AutoUpdateSettings, projectPath string) (bool, string, error) {
	if gitConfig == nil {
		return false, "", nil
	}
	...
	username, password, err := git.GetCredentials(gitConfig.Authentication, dataStore)
	if err != nil {
