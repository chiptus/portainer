...
func (handler *Handler) deleteEdgeStackStatus(tx dataservices.DataStoreTx, stackID portainer.EdgeStackID, endpoint *portaineree.Endpoint) (*portaineree.EdgeStack, error) {
