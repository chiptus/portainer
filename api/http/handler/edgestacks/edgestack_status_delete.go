...
func (handler *Handler) deleteEdgeStackStatus(tx dataservices.DataStoreTx, stackID portaineree.EdgeStackID, endpoint *portaineree.Endpoint) (*portaineree.EdgeStack, error) {
