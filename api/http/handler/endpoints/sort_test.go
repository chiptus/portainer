...
func TestSortEndpointsByField(t *testing.T) {
	environments := []portaineree.Endpoint{
...
func getEndpointIDs(environments []portaineree.Endpoint) []portainer.EndpointID {
	return slices.Map(environments, func(environment portaineree.Endpoint) portainer.EndpointID {
