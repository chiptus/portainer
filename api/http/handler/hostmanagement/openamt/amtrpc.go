...
func (handler *Handler) getEndpointAMTInfo(endpoint *portaineree.Endpoint) (*HostInfo, string, error) {
	ctx := context.TODO()
...
func (handler *Handler) PullAndRunContainer(ctx context.Context, endpoint *portaineree.Endpoint, imageName, containerName string, cmdLine []string) (output string, err error) {
...
func (handler *Handler) activateDevice(endpoint *portaineree.Endpoint, settings portaineree.Settings) error {
	ctx := context.TODO()
