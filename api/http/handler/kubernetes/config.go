...
func (handler *Handler) buildConfig(r *http.Request, tokenData *portaineree.TokenData, bearerToken string, endpoints []portaineree.Endpoint, isInternal bool) (*clientV1.Config, *httperror.HandlerError) {
...
func (handler *Handler) buildCluster(r *http.Request, endpoint portaineree.Endpoint, isInternal bool) clientV1.NamedCluster {
