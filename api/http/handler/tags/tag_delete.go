...
func deleteTag(tx dataservices.DataStoreTx, tagID portaineree.TagID) error {
...
func updateEndpointRelations(tx dataservices.DataStoreTx, endpoint portaineree.Endpoint, edgeGroups []portaineree.EdgeGroup, edgeStacks []portaineree.EdgeStack) error {
