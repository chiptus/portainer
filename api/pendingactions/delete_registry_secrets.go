...
func (service *PendingActionsService) DeleteKubernetesRegistrySecrets(endpoint *portaineree.Endpoint, registryData *DeletePortainerK8sRegistrySecretsData) error {
