...
type buildCmdFunc func(stack *portaineree.Stack, opts unpackerCmdBuilderOptions, registries []string, env []string) []string
...
func (d *stackDeployer) buildUnpackerCmdForStack(stack *portaineree.Stack, operation StackRemoteOperation, opts unpackerCmdBuilderOptions) ([]string, error) {
...
func buildDeployCmd(stack *portaineree.Stack, opts unpackerCmdBuilderOptions, registries []string, env []string) []string {
	cmd := []string{}
...
func buildUndeployCmd(stack *portaineree.Stack, opts unpackerCmdBuilderOptions, registries []string, env []string) []string {
	cmd := []string{}
...
func buildComposeStartCmd(stack *portaineree.Stack, opts unpackerCmdBuilderOptions, registries []string, env []string) []string {
	cmd := []string{}
	cmd = append(cmd, UnpackerCmdDeploy)
	cmd = appendGitAuthIfNeeded(cmd, stack)
	cmd = appendSkipTLSVerifyIfNeeded(cmd, stack)
...
// undeploy [-u username -p password] [-k] <git-repo-url> <project-name> <destination> <compose-file-path> [<more-file-paths>...]
func buildComposeStopCmd(stack *portaineree.Stack, opts unpackerCmdBuilderOptions, registries []string, env []string) []string {
	cmd := []string{}
	cmd = append(cmd, UnpackerCmdUndeploy)
	cmd = appendGitAuthIfNeeded(cmd, stack)
	cmd = append(cmd, "-k")
...
// swarm-deploy [-u username -p password] [--skip-tls-verify] [-f] [-r] [-k] [--env KEY1=VALUE1 --env KEY2=VALUE2] <git-repo-url> <git-ref> <project-name> <destination> <compose-file-path> [<more-file-paths>...]
func buildSwarmDeployCmd(stack *portaineree.Stack, opts unpackerCmdBuilderOptions, registries []string, env []string) []string {
	cmd := []string{}
...
func buildSwarmUndeployCmd(stack *portaineree.Stack, opts unpackerCmdBuilderOptions, registries []string, env []string) []string {
	cmd := []string{}
...
func buildSwarmStartCmd(stack *portaineree.Stack, opts unpackerCmdBuilderOptions, registries []string, env []string) []string {
	cmd := []string{}
...
// swarm-undeploy [-k] <project-name> <destination>
func buildSwarmStopCmd(stack *portaineree.Stack, opts unpackerCmdBuilderOptions, registries []string, env []string) []string {
	cmd := []string{}
...
func appendGitAuthIfNeeded(cmd []string, stack *portaineree.Stack) []string {
...
func appendSkipTLSVerifyIfNeeded(cmd []string, stack *portaineree.Stack) []string {
