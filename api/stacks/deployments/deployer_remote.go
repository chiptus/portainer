...
func (d *stackDeployer) remoteStack(stack *portaineree.Stack, endpoint *portaineree.Endpoint, operation StackRemoteOperation, opts unpackerCmdBuilderOptions) error {
	ctx := context.TODO()
