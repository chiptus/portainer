...
func (b *ComposeStackFileUploadBuilder) SetGeneralInfo(payload *StackPayload, endpoint *portaineree.Endpoint) FileUploadMethodStackBuildProcess {
...
func (b *ComposeStackFileUploadBuilder) Deploy(payload *StackPayload, endpoint *portaineree.Endpoint) FileUploadMethodStackBuildProcess {
	if b.hasError() {
		return b
	}
