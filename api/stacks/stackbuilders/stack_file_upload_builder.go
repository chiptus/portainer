...
type FileUploadMethodStackBuildProcess interface {
	...
	SetGeneralInfo(payload *StackPayload, endpoint *portaineree.Endpoint) FileUploadMethodStackBuildProcess
	...
	Deploy(payload *StackPayload, endpoint *portaineree.Endpoint) FileUploadMethodStackBuildProcess
...
func (b *FileUploadMethodStackBuilder) SetGeneralInfo(payload *StackPayload, endpoint *portaineree.Endpoint) FileUploadMethodStackBuildProcess {
...
func (b *FileUploadMethodStackBuilder) SetUploadedFile(payload *StackPayload) FileUploadMethodStackBuildProcess {
	...
	projectPath, err := b.fileService.StoreStackFileFromBytesByVersion(stackFolder, b.stack.EntryPoint, b.stack.StackFileVersion, payload.StackFileContentBytes)
	if err != nil {
...
func (b *FileUploadMethodStackBuilder) Deploy(payload *StackPayload, endpoint *portaineree.Endpoint) FileUploadMethodStackBuildProcess {
	if b.hasError() {
		return b
	}
