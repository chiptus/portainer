...
import type { MotdMotdResponse } from '../portainerEEAPI.schemas';
...
): Promise<AxiosResponse<MotdMotdResponse>> => axios.get(`/motd`, options);

export const getMotdQueryKey = () => [`/motd`] as const;

export const getMotdQueryOptions = <
  TData = Awaited<ReturnType<typeof motd>>,
  TError = AxiosError<unknown>
>(options?: {
  query?: UseQueryOptions<Awaited<ReturnType<typeof motd>>, TError, TData>;
