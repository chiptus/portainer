  ...
  $onInit() {
    return this.$async(async () => {
      ...
      this.command = {
        ...
        winCommand: `curl https://downloads.portainer.io/agent-stack-ee${this.state.agentShortVersion}-windows.yml -o agent-stack-windows.yml ; docker stack deploy --compose-file=agent-stack-windows.yml portainer-agent `,
