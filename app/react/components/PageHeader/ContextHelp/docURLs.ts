...
const definitions: DocumentationDefinitions[] = [
  ...
  {
    desc: 'Kubernetes / More Resources / Service Accounts',
    docURL:
      'https://docs.portainer.io/user/kubernetes/more-resources/service-accounts',
    locationRegex: /#!\/\d+\/kubernetes\/moreResources\/serviceAccounts/,
    examples: ['#!/1/kubernetes/moreResources/serviceAccounts'],
  },
  {
    desc: 'Kubernetes / More Resources / Cluster Roles',
    docURL:
      'https://docs.portainer.io/user/kubernetes/more-resources/cluster-roles',
    locationRegex: /#!\/\d+\/kubernetes\/moreResources\/clusterRoles/,
    examples: ['#!/1/kubernetes/moreResources/clusterRoles'],
  },
  {
    desc: 'Kubernetes / More Resources / Roles',
    docURL:
      'https://docs.portainer.io/user/kubernetes/more-resources/namespace-roles',
    locationRegex: /#!\/\d+\/kubernetes\/moreResources\/roles/,
    examples: ['#!/1/kubernetes/moreResources/roles'],
  },
  {
