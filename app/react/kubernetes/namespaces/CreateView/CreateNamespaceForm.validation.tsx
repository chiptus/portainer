...
import { annotationsSchema } from '../../annotations/validation';
import { loadBalancerValidationSchema } from '../components/LoadBalancerFormSection/loadBalancerValidationSchema';
...
import { storageQuotaValidationSchema } from '../components/StorageQuotaFormSection/storageQuotaValidationSchema';
...
export function getNamespaceValidationSchema(
  ...
  return object({
    ...
    loadBalancerQuota: loadBalancerValidationSchema,
    ...
    storageQuota: storageQuotaValidationSchema,
  });
}
